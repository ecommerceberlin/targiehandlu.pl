...
## The categories of personal data that we process and the voluntary provision of such data

3. We organize the Ecommerce Warsaw Expo - Targi eHandlu ("Fair"). If you want to participate in the Fair as a Participant - Visitor ("Participant"), you can do so freee of charge after registering on the Fair website and providing the following personal data:
...
4. The Company is also the organizer of Call for Papers Contest (‘Contest’), 
...
it will be impossible to conclude an agreement between the Administrator and the Participant, 
under which the Participant will receive an admission ticket to the Fair. 
...
1) generating an individual admission ticket for the Fair for you as a Participant in accordance with the Rules for Visitors,

2) to verify the Participant’s identity at the entry to the Fair under the Rules for Visitors,

3) to realize communication-related to the Fair, under the Rules for Visitors,

4) to send emails as mentioned in the point 9, under the Rules for Visitors,

5) to realize direct marketing activities for Administrator’s services – email communication related to the current and subsequent editions of the Fair,

6) to verify if the voter has voted in the Contest.

7) to promote the event in social media

8) in order to handle any of your complaints, inquiries, requests, and moreover, analysis, determination or defense against claims.

## Handing over of personal data to exhibitors at the Fair

8. We hand over the following personal data of Participants to exhibitors at the Fair (the list of exhibitors is available at the Fair’s website: www.targiehandlu.pl): 
name, last name, job position and represented brand (the company of the employer or their own company).

9. Handing over of data mentioned in point 8 consists in providing exhibitors with access to application which contains the above-mentioned data of Participants. 
Through the application exhibitors can contact Participants in order to schedule a business meeting during the Fair, asking the Administrator to send an email. 
However, exhibitors have no access to Participants’ email addresses. Emails are sent by the Administrator. 
A response is sent only if a Participant expresses desire to contact a given exhibitor. 
This communication is realized through private email of the Participant, without the Administrator’s knowledge (the Administrator has no access to this correspondence and is not involved in it).

10. During the Event, exhibitors can scan the QR codes on Participants' tickets.
Scanning of the QR code takes place with the consent of the Participant, using a smartphone. After scanning, the Participant's data provided during registration and listed in point 3 are made available to the Exhibitor in the application, from which they can be downloaded by him.

## Legal basis for personal data processing

11. We process your personal data on the basis of various legal bases. Among them are:

* indispensability to perform the contract concluded between us and you as a Participant, concluded during registration at Targiehandlu.pl. The terms of the contract are specified in the Rules for Visitors,
* implementation of our legitimate interests, in particular direct marketing, fraud prevention, determination, investigation or defense against claims. We hereby explain that direct marketing consists in providing information on the Fair via email, including subsequent editions of the event, especially information that encourages addressees to participate in the Fair. 
* Your consent when you consent to the processing of your data for specific purposes, e.g. you agree to scan the QR code on your ticket or vote in the Competition.
...
* the person whom the data concern withdraws the permission on the basis of which we process the data, and there is no other basis for processing,
