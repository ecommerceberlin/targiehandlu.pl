...
* 1.2.8. **Strona Targów** – udostępniona przez Organizatora w sieci Internet pod adresem https://ecommercewarsaw.com/ strona umożliwiająca między innymi zawarcie Umowy pomiędzy Organizatorem a Wystawcą;
...
* 1.2.20. **Pakiet wystawienniczy “Networking”** - pakiet usług złożony z usług związanych z rejestracją Wystawcy, usług promocyjnych i reklamowych oraz za korzystanie w czasie Targów z przestrzeni wystawienniczej oznaczonej przez oznaczonej przez Organizatora jako Strefa Networking;


# 2. Świadczenia organizatora.

2.1. **Organizator** udostępnia **Wystawcom**, na zasadach określonych w Regulaminie, **Pakiety wystawiennicze** w kategorii wybranej przez Wystawcę, na zasadach określonych Regulaminem.  Organizator oferuje następujące kategorie Pakietów wystawienniczych: Pakiet “Light”, Pakiet „Standard”, Pakiet „Hot”, Pakiet "Super-HOT", Pakiet "Ultra", Pakiet "Grand", Pakiet “Networking”.
...
* 2.2.2. możliwość zamówienia jednego stołu o średnicy min. 70 cm i 2 (dwóch) krzeseł, które zostaną umieszczone na powierzchni o jakiej mowa w pkt 2.2.1.;
...
* 2.3.2. możliwość zamówienia jednego stołu o średnicy min. 70 cm i 2 (dwóch) krzeseł, które zostaną umieszczone na powierzchni o jakiej mowa w pkt 2.3.1.;
...
#### 2.4. W ramach Pakietu wystawienniczego „Networking” Organizator na czas trwania Targów umożliwia Wystawcy korzystanie ze Stoiska, które obejmuje:

* 2.4.1. powierzchnię podłogi Hali (o wymiarach 15 m x 12 m);
* 2.4.2. możliwość zamówienia stolików paletowych (5 sztuk), brandowanych kostek do siedzenia (30 sztuk) lub kostek (15 sztuk) i leżaków (15 sztuk) oraz brandowanych donic (14 sztuk), które zostaną umieszczone na powierzchni o jakiej mowa w pkt 2.4.1.;
* 2.4.3. możliwość umieszczenia na powierzchni o jakiej mowa w pkt. 2.4.1. przygotowanej przez Wystawcę zabudowy oraz atrakcji dla Uczestników Targów (Wystawca jest zobowiązany do przekazania Organizatorowi do akceptacji planu aranżacji strefy minimum 3 tygodnie przed Targami).
* 2.4.4. dostęp do przyłącza elektroenergetycznego o maksymalnej mocy 2000 W (napięcie 230 V);
* 2.4.5. możliwość umieszczenia na powierzchni o jakiej mowa w pkt. 2.4.1. przygotowanych przez Wystawcę Innych materiałów promocyjnych lub mebli Wystawcy stanowiących wyposażenie Stoiska. 

2.5. Organizator ma  prawo do modyfikacji planu rozmieszczenia Stoisk w ramach Hali dokonanej nie później niż 7 dni przed dniem Targów - w szczególności przenosin poszczególnych Stoisk oraz zmiany numeracji Stoisk, jeżeli taka zmiana podyktowana jest względami komfortu Zwiedzających bądź względami bezpieczeństwa. Modyfikacje, o których mowa w pkt 2.5 nie będą wiązały się ze zmianą kategorii Pakietów Wystawienniczych. Organizator dołoży starań, aby modyfikacja, o której mowa w pkt 2.5 powyżej nie miała wpływu na ekspozycję Stoiska Wystawcy i nie osłabiała efektu promocyjnego i marketingowego, co oceni Organizator. Modyfikacja nie stanowi podstawy do żądania obniżenia wynagrodzenia Wykonawcy ani do rozwiązania lub odstąpienia od Umowy.

2.6. W ramach Pakietów Wystawienniczych Organizator umożliwia Wystawcy korzystanie z usług wskazanych w pkt 10.1 i 10.2 Regulaminu.
...
7.1. Wystawca nie może korzystać ze Stoiska w sposób niezgodny z jego przeznaczeniem, w tym w szczególności nie może: korzystać w ramach Stoiska jednocześnie z urządzeń o łącznym poborze mocy większym niż moc przyłącza elektroenergetycznego udostępnionego w ramach Stoiska, umieszczać w ramach Stoiska rollup’u lub ścianki reklamowej o wymiarach większych niż określone dla danej kategorii Pakietu Wystawienniczego. Ścianka Stoiska przylegająca do sąsiedniego Stoiska nie może być wyższa niż 2,5 m i od strony sąsiedniego stoiska musi być estetycznie wykończona (wyłącznie w jednolitym kolorze - czarnym lub białym).
...
8.3. W przypadku odpłatnego udziału publiczności, Wystawca otrzyma specjalny link umożliwiający zakup wejściówek przez osoby trzecie w cenie niższej niż standardowa cena biletu obowiązująca w danym okresie. Dodatkowo, w ramach Pakietu wystawienniczego, Wystawca otrzyma 15 bezpłatnych wejściówek VIP.
...
10.4. Dane umieszczone przez Wystawcę w ramach profilu, tj. nazwa, logo oraz opis działalności, prezentowane będą przez Organizatora w Wirtualnym Katalogu Wystawców dostępnym w ramach Strony Targów. Organizator może również przygotować materiały drukowane, takie jak katalog targowy. Ze względów logistycznych w przypadku edycji opisu, logotypu lub nazwy firmy na mniej niż 14 dni przed datą wydarzenia, zmiany te mogą nie być widoczne w drukowanych materiałach.

10.5. Wystawca z chwilą zawarcia Umowy udziela Organizatorowi nieodpłatnej, nieograniczonej terytorialnie licencji na czas od dnia zawarcia Umowy do dnia 31.12.2028 roku, na korzystanie z materiałów umieszczonych w ramach profilu Wystawcy w celu promocji Targów, w tym kolejnych ich edycji, w środkach masowego przekazu, w tym w szczególności w prasie, radio, telewizji, w ramach Strony Targów, w przekazach kierowanych do ogółu użytkowników sieci Internet za pomocą dowolnych środków przekazu w ramach tej sieci, w wiadomościach e-mail, a także w celu promocji działalności Organizatora w opisanym wyżej zakresie.
...
11.3. Regulamin wchodzi w życie z dniem 14 kwietnia 2025 roku.
